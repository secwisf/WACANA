...
class ArgumentFactory(object):
    ...
    def __init__(self, _abiData, _targetCN):
        ...
        # const data
        self.forgedNotificationAgentName = global_vars.forgedNotificationAgentName
        self.forgedNotificationTokenFromName = global_vars.forgedNotificationTokenFromName# active

        self.testEOSTokenFromName = global_vars.testEOSTokenFromName           # An account invoke xxx.transfer

        self.fakeTransferAgentName = global_vars.fakeTransferAgentName # A fake eosio.token
        self.fakeTransferUserName = global_vars.fakeTransferUserName               # An account invoke fake.token.transfer
    ...
    def generateDataForSimpleType(self, structName):
        ...
        if intRes:
            ...
            return f'\"{global_vars.eosioTokenPublicKey}\"'
