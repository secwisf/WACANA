...
class MemoryLoad:
    ...
    def i16(r: list):
        if utils.is_all_real(r[0], r[1]):
            ...
            return z3.simplify(z3.Concat(r[1], r[0]))
    ...
    def i32(r: list):
        if utils.is_all_real(r[0], r[1], r[2], r[3]):
            ...
            for i in range(len(r)):
                r[i] = utils.to_symbolic(r[i], 8)
            return z3.simplify(z3.Concat(r[3], r[2], r[1], r[0]))
    ...
    def i64(r: list):
        if utils.is_all_real(r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7]):
            ...
            for i in range(len(r)):
                r[i] = utils.to_symbolic(r[i], 8)
            return z3.simplify(z3.Concat(r[7], r[6], r[5], r[4], r[3], r[2], r[1], r[0]))
    ...
    def f64(r: list):
        if utils.is_all_real(r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7]):
            return LittleEndian.f64(r)
        else:
            for i in range(len(r)):
                r[i] = utils.to_symbolic(r[i], 8)
            return z3.simplify(z3.fpBVToFP(z3.Concat(r[7], r[6], r[5], r[4], r[3], r[2], r[1], r[0]),z3.Float64()))

    @staticmethod
    def f32(r: list):
        if utils.is_all_real(r[0], r[1], r[2], r[3]):
            return LittleEndian.f32(r)
        else:
            for i in range(len(r)):
                r[i] = utils.to_symbolic(r[i], 8)
            return z3.simplify(z3.fpBVToFP(z3.Concat(r[3], r[2], r[1], r[0]),z3.Float32()))
            # return z3.simplify(z3.Concat( r[3], r[2], r[1], r[0]))
    ...
    def pack_i64(n: i64):
        if utils.is_all_real(n):
            return [n & 0xFF, (n & 0xFF00) >> 8, (n & 0xFF0000) >> 16, (n & 0xFF000000) >> 24, (n & 0xFF00000000) >> 32,
                    (n & 0xFF0000000000) >> 40, (n & 0xFF000000000000) >> 48, (n & 0xFF00000000000000) >> 56]
        else:
            return [z3.Extract(7, 0, n), z3.Extract(15, 8, n), z3.Extract(23, 16, n), z3.Extract(31, 24, n),
